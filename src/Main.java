...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MemAlgorithm[] memAlgorithms = new MemAlgorithm[]{
                new algorithms.memAlgorithms.FCFS(memSize, 0), new algorithms.memAlgorithms.FCFS(memSize, 1), new algorithms.memAlgorithms.FCFS(memSize, 2),
                new SSTF(memSize, 0), new SSTF(memSize, 1), new SSTF(memSize, 2),
                new SCAN(memSize, 0), new SCAN(memSize, 1), new SCAN(memSize, 2),
                new CSCAN(memSize, 0), new CSCAN(memSize, 1), new CSCAN(memSize, 2)};
